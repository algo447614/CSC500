...
## After two integers are input and verified, then the program will produce both the product and the dividend of the two integers. 
...
dividend_result = num1 / num2

print("Product of numbers:", product_result)
print("Dividend of numbers:", dividend_result)
